...
export default function CartDrawer() {
  const { isOpen, closeCart, items, increaseQty, decreaseQty } = useCart();
  ...
  return (
    <>
      ...
      {/* DRAWER */}
      <div
        className={`fixed top-0 right-0 h-full w-[420px] bg-white z-50 transform transition-transform duration-500 ${
